        ...
        <v-stepper-items>
          <v-stepper-content step="1">
            <v-card flat height="100%" width="100%">
              <v-toolbar dark color="primary">
                ...
                <v-toolbar-title class="white--text">Main informations</v-toolbar-title>
              </v-toolbar>
              <v-card-text>
          ...
          <v-stepper-content step="3">
            <v-card flat height="100%" width="100%">
              <v-toolbar dark color="primary">
                <v-icon>info</v-icon>
                <v-toolbar-title class="white--text">Administration</v-toolbar-title>
              </v-toolbar>
              <v-card-text>
              ...
              <v-card-actions>
                ...
                <v-btn color="primary" @click="back()">Back</v-btn>
                <v-spacer></v-spacer>
                <v-btn color="primary" :disabled="!valid_three" @click="handleSubmit()">Submit</v-btn>
              </v-card-actions>
            </v-card>
          </v-stepper-content>
        </v-stepper-items>
