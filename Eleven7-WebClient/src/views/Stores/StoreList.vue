    ...
    <v-card-text>
      ...
      <v-progress-linear v-slot:progress color="blue" indeterminate></v-progress-linear>
        <template v-slot:items="props">
          <td>{{ props.item.store_id }}</td>
          <td class="text-xs-center">{{ props.item.size }}</td>
          <td class="text-xs-center">{{ props.item.street_num }}</td>
          <td class="text-xs-center">{{ props.item.address_1 }}</td>
          <td class="text-xs-center">{{ props.item.address_2 }}</td>
          ...
          <td class="text-xs-center">
            <v-btn flat @click="Seemore(props.item.store_id)">More</v-btn>
          </td>
        </template>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      { text: "ID", value: "store_id" },
      { text: "Effectif", value: "size" },
      { text: "Street Num", value: "street_num" },
